        ...
        <header class="intro">
            <div class="intro-body">
                <div class="container polaroid">
                    <div class="row">
                            <img src="http://i.imgur.com/OJffOQM.gif" class="img-responsive center-block" style="height:620px;width:1700px;">
        ...
        <section id="about" class="container content-section text-center">
            <div class="container polaroid">
                    <div class="row" style="margin-top: -100px;">
                            <img src="http://i.imgur.com/e55GnMV.gif" class="img-responsive center-block" style="height:620px;width:1700px;">
